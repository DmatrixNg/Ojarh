<?php require_once 'inc/header.php'; ?>
    <?php $catDetails = $userClass->userDetails($_GET['userid']); ?>
                ...
                <div class="container">
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <span itemprop="item"><?php echo @$catDetails->fname; ?></span>
                    ...
                    <div id="shopify-section-collection-infos" class="shopify-section">
                        ...
                        <div class="collection-info banners">
                            ...
                            <div class="collection-info-full">
                              <?php if(isset($catDetails->username)) {?>

                                <h1 class="collection-tille"><?php echo @ucfirst($catDetails->username) .'\'s Product list' ; ?></h1>
                              <?php } ?>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div data-section-id="collection-template" data-section-type="collection-template" class="products-collection">
                            <div class="product-wrapper" id="Collection">
                                <div class="products-listing products-grid grid row default">
                                  <?php $userClass->catalogue_grid($_GET['catid'],$_GET); ?>
                                </div>
                            </div>
                        </div>
                    </div>
