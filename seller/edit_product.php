                ...
                <div class="col-md-7">
                  <div class="card-body">
                    <div class="card">
                      ...
                      <?php } ?>
                      <?php
                              // $value = trim($product->countryorigin,'""');
                              //  $value = trim($value,'"["');
                              //  $value = trim($value,'"]"');
                              //            var_dump($value);

                      // $array =  explode("[]",$product->countryorigin);//$product->countryorigin);
                      //         $arrays =     explode(',',$array[0]);
                      //         $array =[];
                      //         // var_dump()
                      ...
                      <form action="../api/controllers/edit_product.php" method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="productid" value="<?php echo $product->productid; ?>">
                        <div class="card-body">
                          <div class="position-relative form-group">
                            <label for="product_title">Product title</label>
                            <?php //die(print_r($product)) ?>
                          ...
                          <div class="form-row">
                            <div class="col-md-6">
                              <?php //var_dump($userClass->catalogue_dropdown_list()); ?>
                              <label for="market">Product Catalogue</label>
                              <input type="hidden" name="seller" value="<?php echo $product->userid; ?>">
                              <select class="form-control" id="catalogue" name="seller_catalogue"  required>
                                <option value="" selected>Choose...</option>
                                <?php $userClass->catalogue_dropdown_list($product->product_catalogue); ?>
                              </select>
                            </div>

                              <div class="col-md-6">
                                  <label for="market">Product Type</label>
                                 <input type="text" class="form-control" id="product_type" value="<?= $product->product_type; ?>" name="product_type">
                              </div>
                          </div><br>
                          ...
                          <div class="form-row">
                            ...
                            <div class="col-md-6">
                              ...
                              <select multiple="multiple" class="multiselect-dropdown form-control" name="countryorigin[]" id="countryorigin[]" required>
                                <?php $array =  explode("[]",$product->countryorigin);//$product->countryorigin);
                                        $arrays =     explode(',',$array[0]);
                                        $array =[];
                                        // var_dump()
                                        foreach ($arrays as $key => $value) {
                            ...
                            for ($i=0; $i < 8; $i++) {
                              ...
                              if (!is_null($product->$park) && !empty($product->$park)) {
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-4">
                                    <div class="position-relative form-group">
                                      <label for="product_<?= $price ?>" class="">Product Price (in N)</label>
