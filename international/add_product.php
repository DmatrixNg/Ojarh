                                                                            ...
                                                                            <div class="card-body">
                                                                                ...
                                                                                <div class="form-row">
                                                                                    <div class="col-md-6">
                                                                                        ...
                                                                                        <select class="form-control" id="catalogue" name="product_catalogue"  required>
                                                                                            <option value="">Choose...</option>
                                                                                            <?php $userClass->catalogue_dropdown_list(); ?>
                                                                                        </select>
                                                                                        <small class="text-danger"><em>(You must create atlease one Catalogue. <a href='<?= BASE_URL.strtolower($_SESSION['role'])?>/product_catalogue.php'> Set up now</a> )</em></small>
