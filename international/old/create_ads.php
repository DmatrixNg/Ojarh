                      ...
                      <div class="card-body">
                        ...
                        <form action="../api/controllers/add_ad.php" method="post" enctype="multipart/form-data" class='row'>
                          ...
                          <div class="position-relative form-group col-sm-12 col-md-6">
                            ...
                            <select class="form-control" id="addlocation" name="addlocation">
                          ...
                          <div class=" form-group col-sm-12 col-md-6">
                          	...
                          	<button type="button" class="mt-1 btn btn-danger" onclick="payWithPaystack2('<?= $userDetails->email; ?>', '<?= $userDetails->fname; ?>', '<?= $userDetails->lname; ?>',  '<?= $userDetails->phone; ?>', )" id="">Pay</button>
                          </div>
                        </form>
                      </div>
                    </div>
