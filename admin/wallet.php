									...
									<div class="col-md-6 col-xl-4">
											<div class="card mb-3 widget-content bg-secondary">
													<div class="widget-content-wrapper text-white">
															...
															<div class="widget-content-right">
																	<div class="widget-numbers text-white"><span><?php $userClass->totalAdminSales($userid); ?></span></div>
															</div>
													</div>
											</div>
									</div>
                                ...
                                <div class="row m-5">
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="heading heading-2 text-center mb-70">
                                            <h2 class="heading--title">All transaction history</h2>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered dataTable dtr-inline" role="grid" aria-describedby="example_info">
                                        <thead>
																				...
																				<tbody>
																						<?php $userClass->view_all_wallet($userid); ?>
																				</tbody>
