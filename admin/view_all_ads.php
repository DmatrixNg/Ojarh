                                ...
                                <div class="row m-5">
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="heading heading-2 text-center mb-70">
                                            <h2 class="heading--title">View All Adverts</h2>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered dataTable dtr-inline" role="grid" aria-describedby="example_info">
                                        ...
                                        <tbody>
                                            <?php foreach ($userClass->get_ads() as $key => $value): ?>
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td><a class="mb-2 btn btn-shadow btn-outline-success btn-sm" href="../api/controllers/ad_review.php?ad_id=<?php echo $value['id'].'&status=1';?>">
														                        Approve</a>
														                        <a class="mb-2 btn btn-shadow btn-outline-danger btn-sm" href="../api/controllers/ad_review.php?ad_id=<?php echo $value['id'].'&status=3';?>">Reject</button>
														                    </td>
                                                </tr>
                                            <?php endforeach ?>
                                        </tbody>
